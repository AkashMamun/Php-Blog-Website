    ...
    <div class="box round first grid">
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if ($title == "" || $cat == "" || $body == "" || $tags == "" || $author == "" || $file_name == "") {
                ...
                $query = "INSERT INTO tbl_post(cat,title,body,image ,author,tags)VALUES('$cat','$title','$body','$uploaded_image','$tags','$author')";
        ...
        <div class="block">
            <form action="addpost.php" name="title" method="post" enctype="multipart/form-data">
                <table class="form">
